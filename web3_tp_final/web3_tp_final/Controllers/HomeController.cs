...
namespace web3_tp_final.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> GenerateMockUsers()
        {
            ...
            _sitAPupContext.Add(new User { UserName = "Quigid Trunslo", Password="crosemont2021", Email = "trunslo@gmail.com", PhoneNumber = "514-250-2121", Address = "20e Avenue Montréal", Pets = pets1 } );

            List<Pet> pets2 = new List<Pet>();
            pets2.Add(new Pet { Name = "Astro", BirthYear = 2017, Specie = Species.CHAT } );
            _sitAPupContext.Add(new User { UserName = "Gertrev Framab", Password = "crosemont2021", Email = "framab@yahoo.fr", PhoneNumber = "514-250-2120", Address = "21e Avenue Montréal", Pets = pets2 });

            List<Pet> pets3 = new List<Pet>();
            pets3.Add(new Pet { Name = "Chase", BirthYear = 2018, Specie = Species.OISEAU });
            _sitAPupContext.Add(new User { UserName = "Zoirile Wolvlowe", Password = "crosemont2021", Email = "zoirile@videotron.ca", PhoneNumber = "514-250-2119", Address = "22e Avenue Montréal", Pets = pets3 });
